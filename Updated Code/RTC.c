...
//    char decDate[10];
//
//    strcpy(decDate, decode_Weekday(readRTC.day));
//
//    //sprintf(decDate, "%s, %s %d, %d", decode_Weekday(readRTC.day), decode_Month(readRTC.month), readRTC.date, readRTC.year);
//    //sprintf(decDate, "%s %d/%d/%d ", decode_Weekday(readRTC.day), readRTC.month, readRTC.date, readRTC.year);
//
//    return decDate;
//}
...
//
//    if(readRTC.ampm)
//        sprintf(settingScreen.header[2].text, "%d:%02d:%02d PM", readRTC.hour, readRTC.min, readRTC.sec);
//    else
//        sprintf(settingScreen.header[2].text, "%d:%02d:%02d AM", readRTC.hour, readRTC.min, readRTC.sec);
//
//    return decTime;
